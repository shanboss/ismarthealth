...
export default function ReportUploadPage({ params }: ReportUploadPageProps) {
  ...
  useEffect(() => {
    const resolveParams = async () => {
      ...
      const investigation_id = searchParams.get('investigation_id') || resolved.investigation_id;
      const labapproval_id = searchParams.get('labapproval_id') || resolved.labapproval_id;
      const billing_id = searchParams.get('billing_id') || resolved.billing_id;
      const sample_collected_id = searchParams.get('sample_collected_id') || resolved.sample_collected_id;
