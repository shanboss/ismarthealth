...
export default function BillingPage({ params }: BillingPageProps) {
  ...
  const handleDownloadPDF = async () => {
    ...
    try {
      ...
      // Remove problematic CSS variables and colors
        ...
        <head>
          ...
          <style>
            * { margin: 0; padding: 0; box-sizing: border-box; }
            ...
            th { background-color: #f1f5f9; border-bottom: 1px solid #e2e8f0; }
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-60 p-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="p-8 border-b border-gray-100 flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-black text-blue-700 uppercase">
          ...
          <div className="text-right text-sm text-gray-500 space-y-3">
            <p><span className="font-bold text-gray-700">Phone:</span> {labInfo.laboratory_phone}</p>
            <p><span className="font-bold text-gray-700">Email:</span> {labInfo.laboratory_email}</p>
            <div className="flex gap-3">
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg transition-all cursor-pointer"
              ...
              <button 
                ...
                className="flex-1 flex items-center justify-center gap-2 bg-slate-600 hover:bg-slate-700 text-white font-bold py-2 px-4 rounded-lg transition-all cursor-pointer"
                title="Print billing report"
              >
                <Printer size={18} />
                <span>Print</span>
              </button>
        ...
        {/* Main Bill Container */}
        <div ref={billContentRef} className="bg-white rounded-xl shadow-xl border-t-8 border-blue-600 overflow-hidden">
